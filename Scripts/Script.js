function toggleZoneSelect(){
  const y2 = parseInt(document.getElementById("date_fin").value.split("/")[1]);
  if(y2 >= 2026){
    document.getElementById("zoneBloc").style.display = "block";
  } else {
    document.getElementById("zoneBloc").style.display = "none";
  }
}

document.getElementById("date_fin").addEventListener("change", toggleZoneSelect);
...
var zone_high_tarif = Array(15,0);
var zone_mid_tarif  = Array(6,0);
var zone_low_tarif  = Array(2,0);
...
function calculer(){
    ...
    date_fin = document.getElementById("date_fin").value;
    annee_date_fin = parseInt(date_fin.split("/")[1]);
    surface = document.getElementById("surface").value;
    tarif = document.getElementById("tarif").value;
    tarif_new = document.getElementById("tarif_new").value;
    calcul_par_annee = [];
    totaux_des_montants = [];
    ...
    if(tarif == "habitatR2"){
        ...
        for(var i=0; i<date_diff; i++){
            ...
            if(date_debut+i < 2018){
                ...
                totaux_des_montants["total penalite 0.5 %"] += parseFloat(calcul_par_annee[i]["penalite 0.5 %"]);
                totaux_des_montants["total mois de retard"] += parseFloat(calcul_par_annee[i]["mois de retard"]);
            }else if(date_debut+i >= 2023 && date_debut+i <= 2025){
                //alert("date est > 2022");
                date_debut = parseInt(document.getElementById("date_debut").value);
                calcul_par_annee[i] = new Array(10);
                calcul_par_annee[i]["annee"] = date_debut+i;
    ...
    if(annee_date_fin >= 2026){
        if(tarif_new == "HIGH"){ 
            for(var i=0; i<date_diff; i++){
                if(date_debut+i > 2025){
                    date_debut = parseInt(document.getElementById("date_debut").value);
                    calcul_par_annee[i] = new Array(10);
                    calcul_par_annee[i]["annee"] = date_debut+i;
                    calcul_par_annee[i]["surface"] = surface;
                    calcul_par_annee[i]["tarif"] = parseInt(zone_high_tarif[0]);
                    calcul_par_annee[i]["montant"] = parseFloat(surface * calcul_par_annee[i]["tarif"]);
                    calcul_par_annee[i]["penalite 15 %"] = parseFloat(calcule_penalite_15(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 10 %"] = parseFloat(calcule_penalite_10(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 5 %"] = parseFloat(calcule_penalite_5(calcul_par_annee[i]["montant"], date_debut+i));
            ...
            for(var i=0; i<date_diff; i++){
                if(date_debut+i > 2025){
                    ...
                    calcul_par_annee[i]["annee"] = date_debut+i;
                    calcul_par_annee[i]["surface"] = surface;
                    calcul_par_annee[i]["tarif"] = parseInt(zone_mid_tarif[0]);
                    calcul_par_annee[i]["montant"] = parseFloat(surface * calcul_par_annee[i]["tarif"]);
                    calcul_par_annee[i]["penalite 15 %"] = parseFloat(calcule_penalite_15(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 10 %"] = parseFloat(calcule_penalite_10(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 5 %"] = parseFloat(calcule_penalite_5(calcul_par_annee[i]["montant"], date_debut+i));
            ...
            for(var i=0; i<date_diff; i++){
                if(date_debut+i > 2025){
                    ...
                    calcul_par_annee[i]["annee"] = date_debut+i;
                    calcul_par_annee[i]["surface"] = surface;
                    calcul_par_annee[i]["tarif"] = parseInt(zone_low_tarif[0]);
                    calcul_par_annee[i]["montant"] = parseFloat(surface * calcul_par_annee[i]["tarif"]);
                    calcul_par_annee[i]["penalite 15 %"] = parseFloat(calcule_penalite_15(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 10 %"] = parseFloat(calcule_penalite_10(calcul_par_annee[i]["montant"], date_debut+i));
                    calcul_par_annee[i]["penalite 5 %"] = parseFloat(calcule_penalite_5(calcul_par_annee[i]["montant"], date_debut+i));
    ...
    var total_content = "<thead> <tr class=''> <td colspan='3'> المجموع : </td> <td class='hidden'></td> <td>------</td> <td>------</td> <td class='exonere'>"
...
function verify(pos){
    ...
    var total_content = "<tr class=''> <td colspan='3'> المجموع : </td> <td class='hidden'></td> <td>------</td> <td>------</td> <td class='exonere'>"
        +totaux_des_montants["total montant"].toFixed(2)+"</td> <td class='d-none d-sm-table-cell'>"
        +totaux_des_montants["total penalite 15 %"].toFixed(2)+"</td> <td class='d-none d-sm-table-cell'>"
        +totaux_des_montants["total penalite 10 %"].toFixed(2)+"</td> <td class='d-none d-sm-table-cell'>"
        +totaux_des_montants["total penalite 5 %"].toFixed(2)+"</td> <td class='d-none d-sm-table-cell'>"
...
function applyConditionalStyles() {
    ...
    rows.forEach(row => {
        ...
        if (cells.length > 0) {
            var annee = parseInt(cells[3].innerText);
            var montant = parseFloat(cells[6].innerText);
